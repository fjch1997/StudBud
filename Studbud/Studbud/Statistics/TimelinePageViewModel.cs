...
namespace Studbud.Statistics
{
    public class TimelinePageViewModel : INotifyPropertyChanged, ISupportInitialize
    {
        ...
        public string[] YearValues => Enumerable.Range(DateTime.Now.Year - 10, 11).Select(i=>i.ToString()).ToArray();
        public string SelectedYear { get => selectedYear; set { selectedYear = value; OnPropertyChanged(); InitializeChart(); } }
        ...
        private void InitializeChart()
        {
            ...
            if (selectedYear == DateTime.Now.Year.ToString())
                ...
                startTime = new DateTime(int.Parse(SelectedYear), 1, 1);
